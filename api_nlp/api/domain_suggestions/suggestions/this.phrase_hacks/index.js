...
export default function () {
    ...
    if (str_word) {
      ...
      if (this.is_about_nou || this.is_about_ver) {
        ...
        if (this.is_about_ver) {
          ...
          cconsole.error(`gerund of "${str}" is "${gerund}" ?`)
   ...
   * log
   */
  if (DEBUG1) cconsole.log("original plus 1", phrases1)
  if (DEBUG1) cconsole.log("original plus 2", phrases2)
  if (DEBUG1) cconsole.log("original plus 3", phrases3)
