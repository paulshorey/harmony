import stopwords from "data/words/stopwords.js"
/**
...
export default function () {
  ...
  let added_alt = {}
  if (bing_alts.length) {
    if (DEBUG1) cconsole.log("use_autocomplete keys_words:", keys_words)
    if (DEBUG1) cconsole.log("use_autocomplete bing_alts:", bing_alts)
