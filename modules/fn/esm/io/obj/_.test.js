import { is_obj, obj_add, obj_clone, obj_first_value, obj_first_entry, obj_not_empty, obj_has_key, obj_keys_from_array } from ".";
describe("obj", () => {
    it("obj_add", () => {
        const obj = { a: 1 };
        obj_add(obj, "b", 2);
    ...
    it("obj_first_entry", () => {
        ...
        expect(firstItem === null || firstItem === void 0 ? void 0 : firstItem[0]).toEqual("key1");
        expect(firstItem === null || firstItem === void 0 ? void 0 : firstItem[1]).toEqual("val1");
    });
    it("is_obj", () => {
