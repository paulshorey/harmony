...
describe("str", () => {
    ...
    it("str_sanitize", () => {
        expect(str_sanitize(" trim-and_remove_Special-Characters!@#$%^&*()_+1234567890 ")).toBe("trim-and_remove_special-characters_1234567890");
        expect(str_sanitize(" trim-and_remove_Special-Characters!@#$%^&*()_+1234567890 ", {
            allowChars: "\\w\\-_\\$\\!",
            allowUppercase: true
