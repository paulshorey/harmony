...
var Slider = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      /*  arrow  */
      var arrowProps = extractObject(spec, ['arrows', 'arrowsScroll', 'centerMode', 'currentSlide', 'slideCount', 'slidesToShow', 'prevArrow', 'nextArrow', 'arrowsdiv']);
      var prevArrow;
      var nextArrow;
      if (settings.arrows) {
      ...
      if (settings.dots === true && this.items) {
        if (this.items.length >= settings.slidesToShow) {
          ...
          dots = /*#__PURE__*/_react["default"].createElement(_dots["default"], _extends({}, dotProps, {
      ...
      }, this.rerender ? this.newChildren : this.virtualList)), !settings.unslick && judge ? dots : '');
      if (settings === 'unslick') {
