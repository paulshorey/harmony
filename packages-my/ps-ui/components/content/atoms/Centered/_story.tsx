...
export default (args: any) => (
  <Centered {...args}>
    ...
    A regular style text-align:center element would break because of that forced
    extra long line, but this one is still centered. You could set
    ...
    <p>
      <br />
      You wouldn't need to use this for very long text, just short titles where
      one of the lines has <span className="nowrap">`white-space:nowrap`</span>.
    </p>
    <p>
