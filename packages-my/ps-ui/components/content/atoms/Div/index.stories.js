...
const Template = (args) => (
  <Comp css={styles.wrapper} {...args}>
    ...
    <h2
      ...
      `}
    >
      <Comp as="span" mqIframe="display:none;" css={styles.colorGold}>
        Your screen size{' '}
      </Comp>
      <Comp as="span" mqNotIframe="display:none;">
        This page <span css={styles.colorGold}></span>
      </Comp>
      matches following <span css={styles.colorGold}>media queries</span>:
    </h2>
    <Comp as="code" css={styles.codeResults} mqLg="display:block;">
      mqLg
    </Comp>
    <Comp as="code" css={styles.codeResults} mqSm="display:block;">
      mqSm
    </Comp>
    <Comp as="code" css={styles.codeResults} mqDesktop="display:block;">
      mqDesktop
    </Comp>
    <Comp as="code" css={styles.codeResults} mqMobile="display:block;">
      mqMobile
    </Comp>
    <Comp as="code" css={styles.codeResults} mqLargeTablet="display:block;">
      mqLargeTablet
    </Comp>
    <Comp as="code" css={styles.codeResults} mqTablet="display:block;">
      mqTablet
    </Comp>
    <Comp as="code" css={styles.codeResults} mqPhone="display:block;">
      mqPhone
    </Comp>
    <Comp as="code" css={styles.codeResults} mqSmallPhone="display:block;">
      mqSmallPhone
    </Comp>
    <Comp as="code" css={styles.codeResults} mqLargeDesktop="display:block;">
      mqLargeDesktop
    </Comp>
    <Comp
      as="code"
    ...
    <Comp as="code" css={styles.codeResults} mqIPhone="display:block;">
      mqIPhone
    </Comp>
    <Comp as="code" css={styles.codeResults} mqIPad="display:block;">
      mqIPad
    </Comp>
    <Comp as="code" css={styles.codeResults} mqAndroid="display:block;">
      mqAndroid
    </Comp>
    <Comp as="code" css={styles.codeResults} mqWindows="display:block;">
      mqWindows
    </Comp>
    <Comp as="code" css={styles.codeResults} mqMac="display:block;">
      mqMac
    </Comp>
    <Comp as="code" css={styles.codeResults} mqLinux="display:block;">
      mqLinux
    </Comp>
    <Comp as="code" css={styles.codeResults} mqPortrait="display:block;">
      mqPortrait
    </Comp>
    <Comp as="code" css={styles.codeResults} mqLandscape="display:block;">
      mqLandscape
    </Comp>
    <Comp as="code" css={styles.codeResults} mqIframe="display:block;">
      mqIframe
    </Comp>
    <Comp as="code" css={styles.codeResults} mqNotIframe="display:block;">
      mqNotIframe
    </Comp>
    <Comp as="code" css={styles.codeResults} mqNotPhone="display:block;">
      mqNotPhone
    </Comp>
    <Comp as="code" css={styles.codeResults} mqWebview="display:block;">
      mqWebview
    </Comp>
    <Comp as="code" css={styles.codeResults} mqNotWebview="display:block;">
      mqNotWebview
    </Comp>
    <p>
      <br />
    ...
    <Comp as="p" mqNotIframe="display:none;" css={styles.colorGold}>
      If you{' '}
      <a
        href="iframe.html?id=layout-atoms-div-style-props--div-style-props&viewMode=story"
        target="_blank"
    ...
    <p>
      ...
      >
        ...
        <Comp as="b" mqNotIframe="display:none;" css={styles.colorGold}>
          {' '}
          Click "Show code" ↘↘↘
        </Comp>
      </i>
