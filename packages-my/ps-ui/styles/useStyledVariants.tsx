...
export default (
  ...
  if (ssWindows) {
    ssOutput += `${
      deviceInfo?.device === 'Windows' && `${style_to_string(ssWindows, theme)}`
    }\n`;
  }
  if (ssLinux) {
    ssOutput += `${
  ...
  if (ssAndroid) {
    ssOutput += `${
      deviceInfo?.device === 'Android' && `${style_to_string(ssAndroid, theme)}`
    }\n`;
  }
  if (ssIPad) {
    ssOutput += `${
  ...
  if (ssIPhone) {
    ssOutput += `${
      deviceInfo?.device === 'iPhone' && `${style_to_string(ssIPhone, theme)}`
    }\n`;
  }
