...
import wordchunk from "@ps/nlp/api/lib/wordchunk"
import row_model from "@ps/nlp/api/data.words/function/row_model"
...
export default async function (input_str, tld, do_spellcheck) {
  if (DEBUG1) global.cconsole.log("api/lib/chunk_string", input_str, tld)
  let output_arr
  let output_alts
