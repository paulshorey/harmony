import tlds_location_specific from "data/domains/location_specific.js"
import tlds_from_chunks from "api/domain_suggestions/suggestions/this.tlds/function/tlds_from_chunks.js"
// import { arr_subtract, arrays_mix } from "@twodashes/universal/esm/arrays.js"
import { object_keys_from_array_values } from "@twodashes/universal/esm/objects.js"
// import tlds_all from "data/domains/all"
import tlds_black from "data/domains/manual/black"
import mixin_tlds_general from "data/domains/mixins/general"
import mixin_tlds_brand from "data/domains/mixins/brand"
import mixin_tlds_name from "data/domains/mixins/name"
import mixin_tlds_tech from "data/domains/mixins/tech"
import { sort_strings_by_rating_and_position } from "@twodashes/universal/esm/sort_strings"
import sort_preferences_all from "data/domains/sort_preferences_all"
import generic_tlds from "data/domains/mixins/generic"
...
export default async function make_tlds() {
  ...
  if (
    ...
    if (DEBUG1) cconsole.log("yes_tlds sorted", yes_tlds)
    // maybe_tlds = sort_strings_by_rating_and_position(maybe_tlds, sort_preferences_all, 1)
    if (DEBUG1) cconsole.log("maybe_tlds sorted", maybe_tlds)
  }
  ...
  if (DEBUG1) {
    cconsole.info("this.tlds", this.tlds)
    cconsole.info("this.tlds_use", this.tlds_use)
    // cconsole.info("this.tlds_extra", this.tlds_extra)
  }
