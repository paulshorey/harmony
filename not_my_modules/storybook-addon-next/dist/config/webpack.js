...
const configureConfig = (baseConfig, nextConfigPath) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
const resolveNextConfig = (baseConfig, nextConfigPath) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const nextConfigExport = yield Promise.resolve().then(() => tslib_1.__importStar(require(nextConfigPath ? nextConfigPath : path_1.default.resolve('next.config.js'))));
    const nextConfig = typeof nextConfigExport === 'function'
