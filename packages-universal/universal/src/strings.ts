 ...
 */
export function matrix_horizontal_string_combinations(
 ...
 */
export function strings_shuffle_last2(input_strs = []): Array<string> {
  let memory_strs = [];
  let unique_strs = [];
 ...
 * @returns {array} - new array (immutable), of shuffled strs
 */
export function strings_shuffle_first_last2(input_strs = []): Array<string> {
  let memory_strs = [];
  let unique_strs = [];
 ...
 * @returns {array} - new array (immutable), of shuffled strs
 */
export function strings_shuffle_first2(input_strs = []): Array<string> {
  let memory_strs = [];
  let unique_strs = [];
