...
/*
 * This is an old function, maybe ready to be removed. But it works very well.
 *
 * Compare to src/hooks/useVariants.js which is newer, written like a hook, with added functionality to get theme.
 *
 * But this works for templates/About - <Grid css={styles.howWeHelp}>, where useVariants does not!
 *
 * TODO: debug that. Maybe combine the two functions.
 */
