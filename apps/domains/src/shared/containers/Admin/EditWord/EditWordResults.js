...
export default function (props) {
  ...
  return (
    <Styled className="EditWord content">
      {/*View*/}
      <Link className={"editWordLink"} href={`/thesaurus?str=${that.props.input_str}`}>
        <a>
          <FA icon={"fa-eye"} className="faEye" style={{ transform: "scale(0.85)" }} />
        </a>
      </Link>
      <Link
      ...
      >
        <a>
          <FA icon={"fa-trash-alt"} className="faTrashAlt" style={{ transform: "scale(0.85)" }} />
        </a>
      </Link>
      {/*Key*/}
