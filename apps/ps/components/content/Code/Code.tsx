...
const Code = ({
  ...
  // default theme
  if (dataVariants.includes('transparentDark')) {
    theme.plain.backgroundColor = 'rgba(0,0,0,0.54)';
  } else if (dataVariants.includes('transparentLight')) {
    theme.plain.backgroundColor = 'rgba(222,222,222,0.22)';
  } else {
    theme.plain.backgroundColor = 'hsl(50deg 2% 16%)';
  }
