...
function Home(props) {
  return (
    <HCarousel {...props}>
      <span href="/photos/aboutus/aboutus.jpg">
      ...
      <span href="/photos/aboutus/desk-paul.jpg">
      ...
      <span href="/photos/me/via-ferrata.jpg">
      ...
      <span href="/photos/me/hg-crestline.jpg">
      ...
      <span href="/photos/me/city-paul.jpg">
      ...
      <span href="/photos/aboutus/aboutus-utah-road.jpg">
