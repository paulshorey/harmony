 ...
 */
export const Component = forwardRef(({ ...props }: Props, ref: any) => {
 ...
 */
const StyledComponent = withStyles(Component, 'InfiniteCarousel', variants);

export default memo(StyledComponent);

export const withInfiniteCarousel = (props: Props) =>
  memo(withCombinedProps(StyledComponent, props));
