...
This uses `styled-components`. Just like <CodeInline code={`styled.button\`\``}/> or <CodeInline code={`styled.div\`\``}/>, you can use <CodeInline code={`withButton()`}/> or <CodeInline code={`withDiv()`}/>  

**Plus an added feature:** pre-define <Inline as="b" textcolor="accent"> props</Inline> as well as styles. This is a great way to keep your code clean, separate markup from style, data-generated props from unique manually added props.  
