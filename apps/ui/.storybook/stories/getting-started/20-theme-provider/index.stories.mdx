...
This UI library `@ps/ui` by design only requires `styled-components` as a peer dependency. NextJS is optional.  
...
Or to customize theme and settings, make a copy of `@ps/ui/components/ThemeProvider` in your app directory. Import that and wrap your app in that. Same with JS and CSS files it imports. Customize anything.  
