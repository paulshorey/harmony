...
Or to customize theme and settings, make a copy of `ThemeProvider.tsx`, `theme.ts` and `theme.css` files in your app directory and use that. Here are the files used to customize your colors, sizes, and variables:  
