...
<Wrapper>
  ...
  <hr />
  <h3>
    It's a starter kit for easily making <Block as="span" className="text-rainbow"> and branding </Block> your own UI library.
  </h3>

<Code code={`import { Block } from '@ps/ui/components/content/Block';`} />
