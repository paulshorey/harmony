...
import { ssProp, styledTags } from '@ps/ui/types/styles';
...
type Props = {
  ...
  props: any;
  /*
   * Pass the component to style. Can be any component or even a styled component. Alternatively, pass props.tagName to create a new styled component from the HTML tag name. If neither is defined, this hook will make a div.
   */
  Component?: any;
  /*
   * Any HTML element supported by styled-components. Such as "div" as in styled.div``. Alternative to props.Component - this hook will create and return a new component with the styles applied. If neither is defined, this hook will make a "div".
   */
  tagName?: styledTags;
  /*
...
export default ({
  ...
  if (emotionStyles) {
    if (emotionStyles.default) {
      ssDefault += style_to_string(emotionStyles.default, props);
    }
  ...
  if (Component) {
    ...
    StyledComponent = styled(tagName)`
      ${ssDefault}
    `;
  } else {
  ...
  // Add className to enable the extra specificity for the above ssInline
   ...
   * return
   */
  console.log('useStyledComponent has generated classNames:', props.className);
  delete props.theme;
