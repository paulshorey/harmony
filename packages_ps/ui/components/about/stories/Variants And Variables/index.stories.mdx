...
import { Wrapper, Container, Title, Content, Button } from "../../components/Components";

<Meta title="Variants and Variables" id="about-5" />
...
Like classNames, but not only for styling. They are also used in the component code. They can change logic or layout. Each component directory has a `variants.ts`
file in it. In this storybook stories, open any component, then scroll down and select a variant to see what each one does.
