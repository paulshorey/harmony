...
<Meta title="Why is this useful?" id="about-1" />
...
### It's a starter kit for easily making <span className="colors-accent">your own</span> <span className="colors-rainbow"> custom-branded </span> UI library.

<br />

### It's a styling-system for enterprise.

Scalable, with shortcuts for media queries, devices, variables, and colors schemes.
...
- <a href="/">media queries</a> - easily style breakpoints (with JSX props, JS variables,
  or Styled Components HOC)
- <a href="/">variants and themes</a> - use/extend multiple predefined variants (like
  classNames but with Typescript)
...
- React
- Typescript
- Next (for components that generate a link or image)
