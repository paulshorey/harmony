...
<Meta title="Why this is necessary?" id="about-1" />
...
<Wrapper>
  ...
  <hr />
  <h3>
    It's a starter kit for easily making <Span va="text-rainbow"> and branding </Span> your own UI library.
  </h3>
  <p><strong>It's a styling-system for enterprise.</strong><br />
  Scalable, with shortcuts for media queries, devices, variables, and colors schemes.</p>
  <p>
