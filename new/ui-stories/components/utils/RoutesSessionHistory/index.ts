...
const RoutesSessionHistory = () => {
  ...
  const handleUpdateRoutesSessionHistory = (path: string) => {
    /**
...
export { RoutesSessionHistory, useRoutesSessionHistory };
