...
export default (args: any) => {
   ...
   */
  return (
    <Block ss={styles.wrapper} variant="bg-gradient text-color" color="cta1" {...args}>
      <h2 className="text-3xl font-bold underline">This is not a UI Component Library...</h2>
      <hr />
      <h3>
        <b>It's a starter kit for easily making your own custom branded UI library.</b>
      </h3>
      <p>It's a styling-system with shortcuts for media queries, devices, variables, and colors chemes. Includes interactive JavaScript functionality.</p>
      <p>
        Great for a mono-repo. This library can be imported by multiple apps. Each app can extend the base theme and functionality.
      ...
      <p>
        This is a work in progress, but already useful. <span className="nowrap">Read more:</span>
      </p>
      <ul>
        <li>
          <a href="/">media queries</a> - easily style breakpoints (with JSX props, JS variables, or Styled Components HOC)
        </li>
        <li>
          <a href="/">variants and themes</a> - use/extend multiple predefined variants (like classNames but with Typescript)
        </li>
      </ul>
      ...
      <p>
        ...
        actually don't support the "C" part. They're usually just S-in-JS. But that's not as catchy. 😆{" "}
      </p>
      <p>
